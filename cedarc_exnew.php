...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO `cedarc_external`(`id`, `cedarc_number`, `patient_name`, `bhd_number`, `age`, `gender`, `specimen_name`, `sample_date_time`, `slideissue_date`, `report_deliver_date`) 
  ...
  if($result) {
    header("Location:cedarc_external.php?msg=New record created successfully;");
  }
  else {
...
<head>
    ...
    <title>Cedarc External New</title>
...
body {
  ...
  <div class="container d-flex justify-content-center">
    <form action="" method="post" style="width:50vw; min-width:300px;">
      ...
      <br>
      <div>
      <a href="cedarc_external.php" class="btn btn-dark">Back</a>
      <button type="submit" class="btn btn-success" name="submit">Save</button>
      <a href="cedarc_exnew.php" class="btn btn-danger">Cancel</a>
      </div>
    </form>
  </div>
</div>
