...
<div class="container">
  ...
  <a href="cedarc_innew.php" class="btn btn-dark mb-3">Add New</a>
  ...
  <tbody>
    ...
    $sql="SELECT * FROM `cedarc_internal` ";  
    if (!empty($search)) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        echo '<tr>
           ...
           <td>' . $row['report_deliver_date'] . '</td>
            ...
            <a href="cedarc_internal.php" class="link-dark" onclick="confirmDelete("cedarc_number")">
